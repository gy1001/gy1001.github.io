import{_ as l,M as o,p as c,q as s,R as e,t as i,N as d,a1 as t}from"./framework-e8cb8151.js";const a={},r=t('<h1 id="_22-web-中的向左向右-flexbox-和-grid-布局中的-ltr-与-rtl" tabindex="-1"><a class="header-anchor" href="#_22-web-中的向左向右-flexbox-和-grid-布局中的-ltr-与-rtl" aria-hidden="true">#</a> 22-Web 中的向左向右：Flexbox 和 Grid 布局中的 LTR 与 RTL</h1><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7fe85803de6642a5b6a04f00b0993c1f~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>几米的绘本《向左走，向右走》自1999年出版，就一直是爱情的代名词。在 Web 的世界中有着同样的故事，即 Web 的向左向右，指的就是 Web 的排版方式（比如，左浮动、右浮动）、对齐方式（比如左对齐、右对齐）、书写模式（比如从左向右、从右向左）等。而 Web 中的向左向右和书写模式、阅读方式有着紧密的关系，它将直接影响着 Web 布局的最终呈现。</p><p>从这节课开始，我将花两节课的篇幅和大家一起来探讨与这方面有关的一些 CSS 技术，使构建一个多语言 Web 网站或应用的过程变得更容易。更希望下次你需要做同样的事情时，能借鉴课程中的一些技术来实现你的项目。</p><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>',5),u={href:"https://zh.wikipedia.org/wiki/%E4%B8%96%E7%95%8C%E8%AA%9E%E8%A8%80",target:"_blank",rel:"noopener noreferrer"},p=e("p",null,"其实，你在访问互联网的 Web 页面，或者使用 Web App 时，很多 Web 网站或 Web 应用都提供了多语言设置。在 Web 中，不同的语言在电子屏幕上有着不同的呈现方式，比如：",-1),m=e("p",null,[e("img",{src:"https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/44e446f56a2a4b5384e73ab0407d2e26~tplv-k3u1fbpfcp-zoom-1.image",alt:"img"})],-1),v={href:"https://zh.unesco.org/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://en.wikipedia.org/wiki/Official_languages_of_the_United_Nations",target:"_blank",rel:"noopener noreferrer"},g=t(`<p>从上图可以看出，在互联网上有些语言是从左到右排列（查看），比如中文、英语、法语等，也有一些语言是从右到左排列（查看），比如阿拉伯语、波斯语、乌尔都语，维吾尔语，哈萨克语等（这些都是阿位伯语系）。</p><p>阿拉伯语系是互联网语言的第七大最常用的语言，全世界大约有超过 2.92 亿人将阿拉伯语作为第一语言。阿拉伯语网站或应用的数量每天都在不断增加。然而，奇怪的是，阿拉伯语系（大部分是在中东市场）要求的设计不仅要符合他们的需求和用户的舒适度，而且还要符合他们的语言标准，这使得开发者在开发相关应用的过程变得更为复杂。考虑到阿拉伯系都是从右到左书写和阅读的，开发人员在开发的时候常常会面临一系列问题。</p><blockquote><p>注意：阿拉伯语不是唯一从右向左书写的语言。波斯语和希伯来语也是以同样的方式书写的。</p></blockquote><p>虽然这看起来没什么大不了的，但是从右到左（<code>RTL</code>）语言的开发需要注意很多相关的细节，而且这方面的资源也不多。对于开发者而言，仅从右向左（<code>RTL</code>）或从左向右（<code>LTR</code>）单方面而言，事情会相对更简单，但是如果两种方式混合在一起，事情就会变得较为复杂。</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/312fadea1a5e4073a767f388e7a66f21~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>简单地说呢，就是按照书写模式来呈现不同的效果。就目前来看，主要的方式就是从左向右（<code>LTR</code>）或从右向左（<code>RTL</code>），在某些场景下也有垂直方向的书写模式，比如从上往下（古代的汉文就是这样的书写模式）。对于开发者而言，从左向右（<code>LTR</code>）并不是件难事，因为我们平时做的，处理方式都是这种。但我们不能仅局限于以往，很有可能你面对的用户群体是阿拉伯语系，那你就要改变以往的处理方式。</p><p>面对不同语言场景，你可能会先想到，“界面必须翻转”。看上去很诡异，但这也是 <code>LTR</code> 转换成 <code>RTL</code>要做的第一件事情。比如 Facebook 官网的首页：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/43654b83eef84c239e5caac0e48dbfd5~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>如果你查看过其源码的话，你会发现在 <code>&lt;body&gt;</code> 元素上设置了 <code>dir</code> 属性，同时在 CSS 中设置了<code>direction</code> 属性：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2d0273d8cf194385bcabb69adcf0d52a~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>从技术角度上来说，Web 开发者需要做两件事，在 HTML 标记中，会使用 <code>lang</code> 属性指定使用的语言，<code>dir</code> 指定阅读模式，一般和语言相匹配。</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!-- 阿拉伯语 --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>ar<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span> <span class="token attr-name">dir</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>rtl<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
​
<span class="token comment">&lt;!-- 简体中文 --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>zh-Hans<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span> <span class="token attr-name">dir</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>ltr<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>客户端默认会根据 <code>lang</code> 和 <code>dir</code> 的设置，提供最初始的样式设置：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 阿拉伯语 */
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Web 开发者也会使用 <code>direction</code> 重置客户端的初始化样式：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 阿拉伯语 */
body {
    direction: rtl;
    unicode-bidi: embed;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>正如上图中示例所示，改变语言和内容是最容易的部分，但当你这样做的时候，有时你要改变的语言有一个不同的方向。例如上图示例中的“简体中文”的文本内容（以及布局）从左到右流动，而阿拉伯语中的文本内容（以及布局）从右到左。</p><p>根据语言不同，对于 Web 开发者而言“改变内容容易，适配布局就不易”。如上面代码所示， HTML 的 <code>dir</code> 和 CSS 的 <code>direction</code> 除了可以控制文档流的方向，还会对 CSS 的部分属性产生影响。我想你可能想知道会对哪些属性有影响，有着什么影响对吧。要是感兴趣，请继续往下阅读！</p><h2 id="和方向有关的-css-功能模块" tabindex="-1"><a class="header-anchor" href="#和方向有关的-css-功能模块" aria-hidden="true">#</a> 和方向有关的 CSS 功能模块</h2><p>在 CSS 中，可以控制排版方向的特性有很多，比如我们熟悉的：</p>`,20),f=e("strong",null,"文本对齐",-1),h={href:"https://www.w3.org/TR/css-text-3/#text-align-property",target:"_blank",rel:"noopener noreferrer"},x={href:"https://www.w3.org/TR/css-text-4/#text-align-property",target:"_blank",rel:"noopener noreferrer"},_=e("code",null,"text-align",-1),k=e("strong",null,"浮动",-1),q={href:"https://www.w3.org/TR/css-page-floats-3/#float-property",target:"_blank",rel:"noopener noreferrer"},S=e("code",null,"float",-1),j=e("strong",null,"定位",-1),w={href:"https://www.w3.org/TR/css-position-3/#box-offsets-trbl",target:"_blank",rel:"noopener noreferrer"},y=e("code",null,"position",-1),L=e("code",null,"left",-1),T=e("code",null,"right",-1),C=e("strong",null,"Flexbox 布局",-1),R={href:"https://www.w3.org/TR/css-flexbox-1/",target:"_blank",rel:"noopener noreferrer"},z=e("code",null,"flex-direction",-1),W=e("strong",null,"Grid布局",-1),F={href:"https://www.w3.org/TR/css-grid-1/",target:"_blank",rel:"noopener noreferrer"},M=e("code",null,"grid-auto-flow",-1),G=e("strong",null,"CSS 框对齐方式",-1),K={href:"https://www.w3.org/TR/css-align-3/",target:"_blank",rel:"noopener noreferrer"},D=e("strong",null,"书写模式",-1),H={href:"https://www.w3.org/TR/css-writing-modes-3/",target:"_blank",rel:"noopener noreferrer"},A=t(`<p>我们来看一个示例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;media&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2b5c49d4bfc445d9906e5b7979a9c1b7~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,5),B={href:"https://codepen.io/airen/full/xxzmbgw",target:"_blank",rel:"noopener noreferrer"},O=t(`<p>CSS Flexbox 和 CSS Grid 布局，不管是 <code>ltr</code> 还是 <code>trl</code> ，都不需要针对不同的书写模式或阅读模式添加额外的 CSS 规则。但对于像 CSS Float 布局，要实现类似 CSS Flexbox 或 Grid 的布局，就需要针对不同的书写模式或阅读模式设置不同的 CSS 样式规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.float .media {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5f6e4d1300024052a1535bf143937a47~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,3),E={href:"https://codepen.io/airen/full/xxzmbgw",target:"_blank",rel:"noopener noreferrer"},N=t(`<p>如果仅从效果上来看，这样的方案的确是解决了<code>dir</code> 或 <code>direction</code> 带来的差异性，但这同时也为开发者增加了不少的工作量，代码也变得更难维护。事实上呢？在 Web 中的 <code>RTL</code> 还有很多事情需要做，甚至是很多技术细节，只有掌握这些，才能在 <code>RTL</code> 这样的场景中游刃有余。</p><h2 id="多语言布局核心概念" tabindex="-1"><a class="header-anchor" href="#多语言布局核心概念" aria-hidden="true">#</a> 多语言布局核心概念</h2><p>多语言 Web 布局，需要了解和掌握的核心概念主要有：</p><ul><li>RTL；</li><li>CSS 逻辑特性；</li><li>CSS 书写模式。</li></ul><p>我们先从 RTL 开始！</p><h3 id="rtl-简介" tabindex="-1"><a class="header-anchor" href="#rtl-简介" aria-hidden="true">#</a> RTL 简介</h3><p>RTL 是 “Right To Left” 首字母的缩写，简单地说就是从右到左，在 Web 中主要是指布局和浏览方式。来看一个 RTL 的 Web 示例图：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dd7f2172a6ef45f18dffac117ca97fdb~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>国内大多数 Web 开发者面对的 Web 排版方式（或者说书写方式）大多是 LTR（即“Left To Right”）。如果你使用浏览器开发者工具审查代码，你会发现客户端下的 <code>&lt;html&gt;</code> 元素的 <code>dir</code> 或它对应的 <code>direction</code> 属性的默认值会是 <code>ltr</code> 。</p><p>注意，HTML 标签元素的 <code>dir</code> 和 CSS 的 <code>direction</code> 属性的值主要有 <code>ltr</code> 和 <code>rtl</code> ，它们分别对应两种书写模式或阅读模式：</p><ul><li><strong>LTR</strong> 书写模式或阅读模式下，HTML 的 <code>dir</code> 和 CSS 的 <code>driection</code> 属性对应的值是 <code>ltr</code> ，表示从左往右书写（或阅读）；</li><li><strong>RTL</strong> 书写模式或阅读模式下，HTML 的 <code>dir</code> 和 CSS 的 <code>direction</code> 属性对应的值是 <code>rtl</code> ，表示从右往左书写（或阅读）。</li></ul><p>两者在 Web 布局中对应的效果如下：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8cf6994c962748d3992131327f113adf~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>正如你所看到的，对于 RTL，文本是从右向左读取的，这正好与 LTR 相反。幸运的是，客户端（比如浏览器）对这方面有较好的支持。如果我们希望切换文档语言的排列方向，最简单的方式就是在文档根元素（即 <code>&lt;html&gt;</code>）显式地设置 <code>dir</code> 属性：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;html dir=&quot;rtl&quot;&gt;
    &lt;!-- HTML 中其他元素 --&gt;
&lt;/html&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),X=e("code",null,"dir",-1),J=e("code",null,"float",-1),Y=e("code",null,"text-align",-1),Z=e("code",null,"dir",-1),I=e("code",null,"auto",-1),P={href:"https://www.w3.org/TR/2011/WD-html5-author-20110809/global-attributes.html",target:"_blank",rel:"noopener noreferrer"},V=t(`<blockquote><p><strong>当文本的排列方向确实未知时，建议开发者仅将此值（<strong><strong><code>dir=&quot;auto&quot;</code></strong></strong>）作为最后的手段，并且不能应用于服务端</strong> 。</p></blockquote><p>另外，除了在 <code>&lt;html&gt;</code> 根元素上之外的任何元素上，我们都可以显式设置 <code>dir</code> 属性。当元素显式设置了 <code>dir</code> 属性值时，客户端会根据 <code>dir</code> 属性做出相应的客户端样式解析。比如：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;p dir=&quot;ltr&quot;&gt;我是一个段落&lt;/p&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>客户端对应的样式：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>p[Attributes Style] { 
    direction: ltr; 
    unicode-bidi: isolate; 
}     
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果显式在元素上设置 <code>dir</code> 的值为 <code>rtl</code> ：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;p dir=&quot;rtl&quot;&gt;أهلا وسهلا بك في المقال!&lt;/p&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>客户端对应的样式则会变成：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> p[Attributes Style] { 
     direction: rtl; 
     unicode-bidi: isolate; 
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面我们看到的是 HTML 元素上 <code>dir</code> 属性取值不同带来的差异。除此之外，在 CSS 中可以通过<code>direction</code> 属性来做相应的调整。如果你去查看Facebook的中文版本和阿拉伯语版本，就会发现它们之间的差异。</p><p>先来看中文版本，通过浏览器开发者工具，你会看到像下图这样的结果：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ad0ae376b5ac416c8c179b11509f51c7~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>可以看到，显式地在 <code>body</code> 中设置了 <code>direction: ltr</code>（正好和 <code>&lt;body&gt;</code> 中 <code>dir</code> 的 <code>ltr</code> 相匹配）。对于 <code>unicode-bidi</code> 属性，这里暂且忽略，就当这个属性未显式地在样式中设置。接着继续看另外一种场景（切换到阿拉伯版本的 Facebook），你会发现在阿拉伯语版本的时候，<code>&lt;body&gt;</code> 中的 <code>dir</code> 属性的值变成了 <code>rtl</code>，同时浏览器默认的 <code>direction</code> 和 CSS 中显式地在 <code>body</code> 中设置的<code>direction</code> 都有所调整：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b461e92d3c6241588427e1744e87a8b7~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>从最佳实践来看，更建议在 <code>&lt;html&gt;</code> 根元素上定义 <code>dir</code> 属性的值，以确保在没有显式设置 CSS 的 <code>direction</code> 样式的情况下也能较好实现双向布局。</p><p>也就是说，你在构建一个多语言的 Web 网站或 Web 应用时，首先要做的是在 <code>&lt;html&gt;</code> 标签元素上显式设置 <code>dir</code> 属性，最好也显式设置 <code>lang</code> 属性，因为 <code>lang</code> 设置的语言的默认书写方式和阅读方式和 <code>dir</code> 属性的值是相匹配的。比如：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 简体中文 --&gt;
...
&lt;div class=&quot;media&quot; dir=&quot;rtr&quot;&gt;
    ...
    &lt;/div&gt;
&lt;/div&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>注意，整站是同一种书写模式或阅读模式，<code>dir</code> 最好设置在 <code>&lt;html&gt;</code> 或 <code>&lt;body&gt;</code> 元素上。</p></blockquote><p>两者最大的差别，就是 <code>&lt;div class=&quot;media&quot;&gt;</code> 容器中 <code>dir</code> 的值分别是 <code>ltr</code> （LTR）和 <code>rtl</code> （RTL）。</p><p>添加一些非布局的样式，你将看到的效果如下：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/716431447a104dc19a72a00e81efd34f~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>正如上图所示，浏览器可以根据 HTML 的 <code>dir</code> 属性值来识别文本书写方式，因为它是在 Unicode 字符集中分配的。但对于 Web 布局，还是需要额外通过 CSS 代码来实现。</p><p>你可以使用 CSS Flexbox 或 CSS Grid 来构建，这里使用 CSS Flexbox ：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.media {
    display: flex;
    gap: 1rem;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d6127ec895434157a7ae5450280da5f6~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,32),Q={href:"https://codepen.io/airen/full/wvXRaZK",target:"_blank",rel:"noopener noreferrer"},U=t(`<p>这就是 CSS Flexbox （或 CSS Grid）构建 LTR 和 RTL 布局的优势之一，具体原因，稍后会介绍。如果换成其他的布局方式，你要做的事情就会更多一些，比如 CSS 浮动布局。如果你只对 <code>figure</code> 做一个左浮动：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.media__object {
    float: left; 
    margin-right: 1rem;
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你将看到的效果如下：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8b5e3b8bf9b40c99291bdc78f546289~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>为了达到让阿拉伯语（LRT）布局也能达到预期效果，在还没有 CSS 逻辑属性之前，你需要在 <code>[dir=&quot;rtl&quot;]</code> 下调整浮动的方向：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.media__object {
    float:left;
    margin-right: 1rem;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，如果使用逻辑属性来替代上面的物理属性，也会变得容易一些：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.media__object {
    float: inline-start;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c1e13e9d1084456ca241982d8eded2f7~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,9),$={href:"https://codepen.io/airen/full/jOKXbEB",target:"_blank",rel:"noopener noreferrer"},ee=t(`<p>你可能发现了，使用浮动布局，主要因为我们使用的都是物理属性，如果将物理属性更换成逻辑属性，事情也会变得容易得多。当然，要是你从未接触过 CSS 逻辑属性，你现在并不知道 CSS 逻辑属性是什么，这也不要紧，稍后我们会详细介绍 CSS 逻辑属性在多语言布局中的作用和对应的优势！</p><h3 id="ltr-和-rtl-混合-让阅读变得更困难" tabindex="-1"><a class="header-anchor" href="#ltr-和-rtl-混合-让阅读变得更困难" aria-hidden="true">#</a> LTR 和 RTL 混合，让阅读变得更困难</h3><p>就 LTR 或者 RTL 单方面而言，都不是太难的事情，但是要将两者混合使用，比如中文（或英文）与阿拉伯语系混合在一起排版，而且布局是 LTR，将会发生什么呢？它们混合在一起的排版效果可能看起来像下图这样：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/09b5415973de4454bfd7d605c36f4ae7~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>就上图而言（默认是 LTR），对于一位阿拉伯语的用户来说，阅读起来是痛苦的，因为排版很混乱。它的读取顺序如下图所示：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cbcf59f6b38046f0bde513ae3d39ce70~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>为了避免这个现象，我们应该尽可能设置适当的语言方向。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 中文和阿拉伯文混合 Left To Right --&gt;
&lt;div class=&quot;media&quot; dir=&quot;ltr&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>事实上，在 CSS Flexbox 布局中，元素是根据文档的书写模式分布的。拉丁语体系（比如英文）和阿位伯语体系（比如阿拉伯语）的默认书写模式为 <code>horizontal-tb</code>。即 <strong>内容从左到右水平流动，从上到下垂直流动。下一条水平线位于前一条平线的下方</strong>。</p><p>当页面的方向被更改为 RTL 时（即 <code>dir=&quot;rtl&quot;</code> 或 <code>direction: trl</code>），Flexbox 会相应地翻转它的元素（Flex 项目）。这是一个巨大的好处！下面图展示了如何根据方向翻转 Flexbox 轴（主轴）。</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0fadcf12f55841b7a363c6e5271c69d8~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>也就是说，使用 CSS Flexbox 构建 Web 布局时，我们不需要针对 LTR 和 RTL 提供不同的样式，它可以根据 <code>dir</code> 或 <code>direction</code> 自动翻转。 <code>flex-direction:row</code> 和 <code>dir</code> 结合起来就可以很好地实现 LTR 和 RTL 的布局效果：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2cb13870d43f41d0b2f2e698ba8608a3~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>利用上面说到的特性，重新来构造媒体对象的布局效果（中文版本和阿拉伯语版本），它会比 CSS 浮动简单地多：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* CSS Float Layout: CSS 逻辑属性 */
.media {
    display: flow-root;
}
​
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个示例中，采用的是 Flexbox 和 Grid 结合的布局，图片区域采用的是 CSS 网格布局，标题和图片区域采用的是 Flexbox 布局。在 Flex 容器 <code>.wrapper</code> 设置 <code>writing-mode</code> 的值为 <code>vertical-lr</code> 或 <code>vertical-rl</code> （相互切换）：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1516e879d6d84ba389db5c740d4833ea~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,5),he={href:"https://codepen.io/airen/full/bGKZVZw",target:"_blank",rel:"noopener noreferrer"},xe=t(`<h2 id="css-grid-中的-ltr-和-rtl" tabindex="-1"><a class="header-anchor" href="#css-grid-中的-ltr-和-rtl" aria-hidden="true">#</a> CSS Grid 中的 LTR 和 RTL</h2><p>和 CSS Flexbox一样，CSS Grid 也依赖于文档的书写模式布局，这和使用 Flexbox 有同样的好处。同样拿媒体对象（Media Object）为例，当方向是 LTR 时，缩略图 <code>.media__objeft</code> 在左侧，主内容 <code>.media__content</code> 在右侧，反之亦然。而且，使用CSS Grid 时，翻转将根据页面的方向自动完成。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- LTR: Left To Right--&gt;
&lt;div class=&quot;media&quot; dir=&quot;ltr&quot;&gt;
    &lt;figure class=&quot;media__object&quot;&gt;
        &lt;img src=&quot;media-object.jpg&quot; alt=&quot;Meida object&quot; /&gt;
    &lt;/figure&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/78f40113b0e04576ae88f5a91299ee71~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>`,4),_e={href:"https://codepen.io/airen/full/JjZzXLW",target:"_blank",rel:"noopener noreferrer"},ke=t('<p>同样的，CSS Grid 也会受 <code>writing-mode</code> 的影响，比如上面示列，当 <code>writing-mode</code> 的值为 <code>vertical-lr</code> 和 <code>vertical-rl</code> 时的效果：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5afc164432f24b06bbd60ad1c1b1d29a~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><p>我们一起来看一个有关于 Logo 的布局设计，它是使用 CSS Grid 和 <code>writing-mode</code> 结合的案例：</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7cefddeae48946e48330276684a74053~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p>',4),qe={href:"https://codepen.io/airen/full/jOKJrmq",target:"_blank",rel:"noopener noreferrer"},Se=t(`<p>这个案例需要的 HTML 结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;h1&gt;
    &lt;span&gt;made&lt;/span&gt;
    &lt;span&gt;by&lt;/span&gt;
    &lt;span&gt;few&lt;/span&gt;
&lt;/h1&gt;
...
span:nth-child(3) {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),je={href:"http://twitter.com/jensimmons",target:"_blank",rel:"noopener noreferrer"},we={href:"https://labs.jensimmons.com/",target:"_blank",rel:"noopener noreferrer"},ye=t(`<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/08cb604f650747ceab9e439a3cc8e192~tplv-k3u1fbpfcp-zoom-1.image" alt="img"></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;header class=&quot;header&quot;&gt;
    ...
    &lt;/div&gt;
&lt;/header&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>关键性的 CSS 代码：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>header {
    display: grid;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基于这些情况之下，你只需要一行代码就可以实现 LTR 和 RTL 的翻转设计：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* LTR */
html[lang=&quot;en&quot;] {
    direction: ltr;
}
​
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>或者直接改变 HTML 元素的 <code>dir</code> 属性值：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- LTR --&gt;
&lt;html lang=&quot;en&quot; dir=&quot;ltr&quot;&gt;&lt;/html&gt;

&lt;!-- RTL --&gt;
&lt;html lang=&quot;ar&quot; dir=&quot;rtl&quot;&gt;&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，多语言网站绝不仅仅只是一种翻转设计，它会涉及到其他一些细节和知识点。在下一节课中，我们将一起探讨 LTR 切换到 RTL 时常见的一些错误！希望对大家以后在构建多语言网站时有所帮助！</p>`,6);function ze(We,Fe){const n=o("ExternalLinkIcon");return c(),s("div",null,[r,e("p",null,[i("世界上有很多种语言（简称"),e("a",u,[i("世界语言"),d(n)]),i("），比如汉语、英语、印度斯坦语、西班牙语、阿拉伯语、俄语、葡萄牙语、德语和法语等。在互联中也有一些常用语言，比如英语、汉语、西班牙语、葡萄牙语、印尼语（马来语）、法语、日语、俄语和德语等。 如果你的团队有一些国际业务，这种现象对于你来说一定不会感到陌生。")]),p,m,e("p",null,[i("上图截取于“"),e("a",v,[i("联合国教科文组织"),d(n)]),i("”官网，上图所列的语言也是"),e("a",b,[i("联合国常用语言种类"),d(n)]),i("。")]),g,e("ul",null,[e("li",null,[f,i(" ：CSS Text Module "),e("a",h,[i("Level 3"),d(n)]),i(" 或 "),e("a",x,[i("Level 4"),d(n)]),i(" 中的 "),_,i("，用来设置文本的对齐方式；")]),e("li",null,[k,i(" ："),e("a",q,[i("CSS Page Floats"),d(n)]),i(" 中的 "),S,i(" 属性，用来改变流的水平方向；")]),e("li",null,[j,i(" ："),e("a",w,[i("CSS Positioned Layout Module Level 3"),d(n)]),i(" 的 "),y,i(" 以及 "),L,i(" 、"),T,i(" 也可以改变水平流的方向；")]),e("li",null,[C,i(" ："),e("a",R,[i("CSS Flexible Box Layout Module Level 1"),d(n)]),i(" 中的 "),z,i("；")]),e("li",null,[W,i(" ："),e("a",F,[i("CSS Grid Layout Module Level 1"),d(n)]),i(" 中的 "),M,i("；")]),e("li",null,[G,i(" ："),e("a",K,[i("CSS Box Alignment Module Level 3"),d(n)]),i(" ；")]),e("li",null,[D,i(" ："),e("a",H,[i("CSS Writing Modes Level 3"),d(n)]),i("。")])]),A,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",B,[i("https://codepen.io/airen/full/xxzmbgw"),d(n)])])]),O,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",E,[i("https://codepen.io/airen/full/xxzmbgw"),d(n)])])]),N,e("p",null,[i("当 "),X,i(" 属性的值被更改时，Web 中的元素会自动切换（但有一个前提，这些元素没有设置其他的属性，比如 "),J,i("、"),Y,i("等）。不过需要特别提出的是，"),Z,i(" 属性值要是为 "),I,i(" 时，它根据解析的内容自动切换方向。就这一点而言，"),e("a",P,[i("HTML规范也有相关的描述"),d(n)]),i("：")]),V,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",Q,[i("https://codepen.io/airen/full/wvXRaZK"),d(n)])])]),U,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",$,[i("https://codepen.io/airen/full/jOKXbEB"),d(n)])])]),ee,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",ie,[i("https://codepen.io/airen/full/jOKXpQa"),d(n)])])]),ne,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",de,[i("https://codepen.io/airen/full/poKqOoK"),d(n)])])]),te,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",le,[i("https://codepen.io/airen/full/MWXZxKo"),d(n)])])]),oe,ce,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",se,[i("https://codepen.io/airen/full/MWXLOWb"),d(n)])])]),ae,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",re,[i("https://codepen.io/airen/full/NWzowrG"),d(n)])])]),ue,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",pe,[i("https://codepen.io/airen/full/oNympPL"),d(n)])])]),me,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",ve,[i("https://codepen.io/airen/full/KKeJQaj"),d(n)])])]),be,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",ge,[i("https://codepen.io/airen/full/gOKEavY"),d(n)])])]),fe,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",he,[i("https://codepen.io/airen/full/bGKZVZw"),d(n)])])]),xe,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",_e,[i("https://codepen.io/airen/full/JjZzXLW"),d(n)])])]),ke,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",qe,[i("https://codepen.io/airen/full/jOKJrmq"),d(n)])])]),Se,e("p",null,[i("再来看一个 "),e("a",je,[i("@JENSIMMONS"),d(n)]),i(" 的 "),e("a",we,[i("Layout Lab"),d(n)]),i(" 网站首页 Hero 区域的布局：")]),ye,e("blockquote",null,[e("p",null,[i("Demo 地址："),e("a",Le,[i("https://codepen.io/airen/full/vYrPKaw"),d(n)])])]),Te,e("blockquote",null,[e("p",null,[i("Demo 地址： "),e("a",Ce,[i("https://codepen.io/airen/full/rNKRMKR"),d(n)])])]),Re])}const Ge=l(a,[["render",ze],["__file","index-22.html.vue"]]);export{Ge as default};
