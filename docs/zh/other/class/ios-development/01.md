...
> 可以包含 多个 UITabBarButton, UITabBarButton又可以包含 tabBarItem.image、tabBarItem.title 
...
* 相关开源框架和项目
  ...
  * 开源Tabbar/Tabbarcontroller 主要是做了简易的封装+5个按钮的样式
...
[Xcode 11版本纯代码设置window.rootviewController](https://www.jianshu.com/p/c30ff97996ce)
