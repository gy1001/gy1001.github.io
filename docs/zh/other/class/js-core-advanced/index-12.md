...
![image.png](./assets/1-20240301171840567.png)image.png
...
例子中，我在 foo 函数内部定义了 bar 函数，执行 foo 函数时，并未执行 bar 函数，而是打印出来看看 bar 函数的详细信息，此时 bar 仅仅只是被预解析，而我们可以看到，在打印结果中，bar 函数的作用域信息已经生成了。![image.png](./assets/1-20240301171840560.png)
...
![image.png](./assets/1-20240301171840559.png)
...
在函数内部，我声明了两个变量 a，b，一个函数 bar。然后观察一下 bar 的作用域链。![image.png](./assets/1-20240301171840552.png)
...
如果我们同时在 bar 中访问了所有变量与函数，那么结果就会不一样。![image.png](./assets/1-20240301171840588.png)
...
![image.png](./assets/1-20240301171840597.png)
...
函数 innerTest 的完整作用域链如下：Local -> Closure(test) -> Script -> Global![image.png](http://wechatapppro-1252524126.cdn.xiaoeknow.com/appxw863qeq2150/image/default/c6Ma0Te1701650975sP.png?imageView2/2/q/80%7CimageMogr2/ignore-error/1)

函数 bar 的完整作用域链如下： Local -> Closure (innerTest) -> Closure (test) -> Script -> Global![image.png](http://wechatapppro-1252524126.cdn.xiaoeknow.com/appxw863qeq2150/image/default/cL3B64x1701650975l0.png?imageView2/2/q/80%7CimageMogr2/ignore-error/1)
