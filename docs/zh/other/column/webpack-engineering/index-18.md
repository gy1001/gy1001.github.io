...
![img](https://img.mukewang.com/5cd963ec000144d306400360.jpg)
...
1. 最后一步就是通过合理的设置`optimization.splitChunks`来划分不同的代码，这部分内容不再展开，之后我会有一篇单独的文章来讲解如何配置`optimization.splitChunks`。
