...
![img](./assets/7719eacf03f94609a99f2afdc714846c~tplv-k3u1fbpfcp-zoom-1.jpeg)

在开始之前，我用一张图来帮助大家回忆一下前面几个有关于 Flexbox 课程的知识，（👇 **点击查看大图**）：

![img](./assets/ff98355476f7467b84c9e078f90de1c2~tplv-k3u1fbpfcp-zoom-1.jpeg)

## 水平垂直居中

![img](./assets/8c01198ca4dc464bb97deb46bed24b2c~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/3ad5d7986528497db38416b4b3d92a2e~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/906e102c13a24fc0bd8fa79a48d41b4b~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/e3017e1bb31f44908b346672802ee472~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/c5c69c3d7a8841f383e11fefc07e2ea8~tplv-k3u1fbpfcp-zoom-1.gif)

> Demo 地址：<https://codepen.io/airen/full/zYjRYGv>

在特定场景或环境之下，这种方式也适用于多行水平垂直居中，比如 Flex 容器没有足够空间致使 Flex 项目断行：

![img](./assets/5ce6793707ed43f2806a19514d86f6a1~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/3f5ca83d6e594ede95f9e8b8d03afd44~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/ad6d0b9521444746980f89b38a99a519~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/597d875282984f93bdc90d1f456dd7a6~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/a3fbdb55eef2475f8e4eb26eb07002cf~tplv-k3u1fbpfcp-zoom-1.jpeg)

留个小作业，请使用 Flexbox 来实现 Logo 图标在其容器中水平垂直居中：

![img](./assets/36524057468a4a87bc4c37c460e069e5~tplv-k3u1fbpfcp-zoom-1.png)

## 等高布局

Web 设计师为了让页面或组件的 UI 更美观，往往会考虑像等高布局这样的效果：

![img](./assets/562140b9b64a4d5ab8a459dd5ac43d2a~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/2a4eb84cb8c74a60a54c3722efef95f8~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/b8cb1a029a484b96a750f61638438f51~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/d2fb01b8e6df41a98827da197e2b950c~tplv-k3u1fbpfcp-zoom-1.gif)

你可能会感到好奇，为什么会这样，又将如何解决？接下来的内容中你会找到答案。我们回到等高布局中来，你可能已经发现了，只要告诉浏览器卡片容器 `.cads`  是一个 Flex 容器，那么所有卡片 `.card` 的高度就相等了，而且会以最高的那张卡片为主：

![img](./assets/24870361a4b044b2a31cbb560f9ec5be~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/43522adf07c24fa4acf69692d7218970~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/783ac5bc36714bd48fd5c8e89eca0e80~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/6feb2bd16cc64635849125b1041cd6f3~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/5c0127ba822b4d64bb8d7337cb36c6c6~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/7242fb19032e44399869fbd7c478aab7~tplv-k3u1fbpfcp-zoom-1.jpeg)

小作业，请使用 Flexbox 布局技术，实现一个等高布局的 Web 页面：

![img](./assets/feaf995a0ce4422294cf1668f5da8143~tplv-k3u1fbpfcp-zoom-1.jpeg)

简单化一下：

![img](./assets/28925d530dfc4b83a1cd2054e49fff6b~tplv-k3u1fbpfcp-zoom-1.jpeg)

## 均分列（等分列）布局

![img](./assets/62633b76141b42afa2ed9a2a87d26658~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/b5e7069ceed440eba14e4bcb05f54468~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/5d145c42cec042f185896965b53644d2~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/c9579e0459c94f988c189573c98fb5b7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/6e857f24ee5b4fe0a5e68fc51903dd21~tplv-k3u1fbpfcp-zoom-1.jpeg)

## 圣杯布局

圣杯布局（Holy Grail Layout）是 Web 中典型的布局模式。它看上去像下图这样：

![img](./assets/2904ccedf47a4d54a320943b95d3b96a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/9ef432a1c8a647ef955746fa8ce67a12~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/e9bce0d4ca284f58b0e14d5f01d5fb06~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/6e4af644a35b4e9dacd26576b7286c02~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/2bbab70579ea45fbacc5eff348f72863~tplv-k3u1fbpfcp-zoom-1.jpeg)

## Sticky Footer 布局

首先用下图来解释什么是 Sticky Footer 布局:

![img](./assets/ec3967489822463985ef32323a5804fb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/c016d75442d949938e591edd0d4c5136~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/063f5253fd884831bde57dd404f327d9~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/3fc9cb0f980645e980395aa1cccb73f8~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/0c2481b4dbfe4cc09f6c1af2f9671dc8~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/b437393646ee44cf8671be0725d11b24~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/4378590856b44862b5a99a56ea84ac55~tplv-k3u1fbpfcp-zoom-1.jpeg)

来看一个具体 Demo 的效果：

![img](./assets/f3b8ad871cfe4934bb6bcde391579767~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/dce0510ca21647f592509c3c6f481b1a~tplv-k3u1fbpfcp-zoom-1.jpeg)

## 12 列网格布局

12 列网格布局最早源于 [960gs 网格布局系统](https://960.gs/)，它和 CSS 原生的网格系统不是同一个东西。简单地说，960gs 就是将页面分成12列，有列宽和列间距，然后页面的布局划分到具体的列上面，如下图所示：

![img](./assets/cf0cb706f6af44b5b266d5d543da42f6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/9085b09237534c4688a6454cebe95a35~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/c4fb3c7f577e4bcc9c7007cbc6efc513~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/f747844a3ce840fc962381a2042b0a4a~tplv-k3u1fbpfcp-zoom-1.jpeg)

在 Web 布局中，我们把这些布局效果都称为 **九宫格布局** 。它们常被运用于 Web 中展示图片（它有自己的专业术语，称之为**图片墙** **Image Galler** ）。这样的布局对于图片展示来说，可以更好地突出需要展示的图片。

![img](./assets/db685e4cd7394e3289f5ebf00f356096~tplv-k3u1fbpfcp-zoom-1.jpeg)

虽然使用 Flexbox 可以构建一个网格布局，但 Flexbox 布局毕竟是一种**一维布局** ，用它来构建上图这样的九宫格布局效果，还是有一定的局限性，需要通过 HTML 结构强力配合才能实现。比如下面这个示例：

![img](./assets/e5044df132544bc58782aa64b5d66e0b~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/613a65775ab34c9fb2f6e7903dace483~tplv-k3u1fbpfcp-zoom-1.jpeg)

> Demo 地址： <https://codepen.io/airen/full/yLjKzgp>

你甚至可以使用 12 列网格布局的方式来完成九宫格的布局。但很多时候九宫格布局中的每个元素 （Flex 项目）具有一定的宽高比：

![img](./assets/76550027a2874769b1207bda43642d5a~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/934a411110de4c3e80efb1ca3f150af4~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/d6d45da301c949e5b41546ff09888806~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/9ea841db252a48cd9e67d1efb02c4d55~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/f0e8375028be4c258141f7e7a2a7272c~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/289d53df61674b3483762cbb48473e98~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/be2292f8c177481089755170a0535499~tplv-k3u1fbpfcp-zoom-1.jpeg)

> Demo 地址： <https://codepen.io/airen/full/OJZvQop>

添点料进去（加上`<img>`），那么具有宽高比的图片墙（九宫格）布局效果就有了：

![img](./assets/3dd08f8caed04bedbc520503e7f6c88c~tplv-k3u1fbpfcp-zoom-1.jpeg)

> Demo  地址： <https://codepen.io/airen/full/QWrmmGZ>

小作业，请使用 Flexbox 和 `aspect-ratio` 构建下图这样的布局效果：

![img](./assets/6131cb0a0b4648e0a4b4c9e11447e7af~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/ca48a36541004c7e8b85e23f03c1dcf1~tplv-k3u1fbpfcp-zoom-1.png)

正如你看到的，上图中红色框是不太适合使用 Flexbox 来布局，但蓝色框中的布局效果，使用 Flexbox 就比较适合。

以下图中的导航栏为例：

![img](./assets/d92b0390c465481c9586ff30b146a87c~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/8b4bacf532ab4c6ab26a2f6879759bff~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/0816d87afffe46c698364b2aabe761ae~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/565a113fd3374632a67fa716da17823a~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/cf35e662f5e5423f8dd9a05ead209ef6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/70370e1aae6943518603934c3eac46e6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/39ae09d88c374793865036130dd9cb0c~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/f06264b0eee94db6b3b019c7e8621559~tplv-k3u1fbpfcp-zoom-1.jpeg)
