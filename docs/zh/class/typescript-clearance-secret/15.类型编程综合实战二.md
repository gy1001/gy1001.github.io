...
![](./assets/baa435154188455fb18f045fcc7fb5bd~tplv-k3u1fbpfcp-watermark.gif)
...
```
当传入 number 参数时：
![](./assets/cca4da44f3d84685ad33cdba9fe9110f~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/6fc6af466fda4757894caa1ae9a85716~tplv-k3u1fbpfcp-watermark.gif)

函数类型可以取交叉类型，也就是多种类型都可以，其实也是函数重载的意思：

![](./assets/db167ed7cbee4bc8a9facc31bae34d08~tplv-k3u1fbpfcp-watermark.gif)
...
![](./assets/a3155d72396b4d958fd4453e0c6cfef1~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/4f38331948a74232a82da6339ee7b653~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/bcb7f4931cef4f109b01f93c92013645~tplv-k3u1fbpfcp-watermark.png)

然后再通过 ReturnType 取返回值的类型，就取到了联合类型的最后一个类型：

![](./assets/9e451d278ee943548565dc3df49ae2d2~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/60724bc96e1c4c22a9d8166cec03e221~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/c3c69b5b51e04fc79168e40e45dfd170~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/6e590182ed5c4209b393fec881490f41~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/d0c1284106c549409b0a369c3e661090~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/92b2052f392d475c80d4a42c8a006c7c~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/fd40148e85ae4dd293598c9433286215~tplv-k3u1fbpfcp-watermark.png)
...
![](./assets/d70b5fb373664c9fb4bad65932786550~tplv-k3u1fbpfcp-watermark.png)
