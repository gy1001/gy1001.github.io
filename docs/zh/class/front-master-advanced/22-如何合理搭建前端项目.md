...
![image (9).png](./assets/CgqCHl8yWpuAcwJgAAAqnGP7ZbA995.png)
...
![image (10).png](./assets/CgqCHl8yWsqAN-CGAAHUx-NKShw605.png)
...
从上面的例子可以看到，husky 同构监听 git 钩子，不仅可以校验提交消息，还可以调用自定义的 npm 脚本进行代码校验或执行测试代码。
