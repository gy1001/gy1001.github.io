...
![img](./assets/19471b0f0ca840c09cfcd6b4daf2f441~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/62c1c51020654c77a9faf94c6146f43f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/ae8ccde88ae94e388216eb2c39c15d53~tplv-k3u1fbpfcp-zoom-1.png)

大家可以看一下 Vite 的社区模板库，tailwind 几乎就是标配。

<https://github.com/vitejs/awesome-vite#templates>

![img](./assets/042bb600c2e44f33929d467fcc9b0da5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/0011645188d3478b9d96d2f5156078ca~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/7820a51c7e2a4b169d0804b0b3e7f927~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/de83381a618c4a39a7b8aef063e3f924~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/f8613673a6dc4c34b7b73547bbce8505~tplv-k3u1fbpfcp-zoom-1.png)

参考代码放在这 ：<https://github.com/smarty-team/smarty-admin/>

使用同样的方式，给按钮定制各种样式。这里面就不赘述。最后看一下效果。

![img](./assets/48a319814f1e4f0598e37e0220970638~tplv-k3u1fbpfcp-zoom-1.png)

### 【 Icon 图标按钮】实现

![img](./assets/16b0e63fbfaf469a8ea5e642a6735ea0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/1b3c1022116a48a78ca902a78cf3b774~tplv-k3u1fbpfcp-zoom-1.png)

如果你想使用一个 【 🔍 】 搜索，首先可以在 [iconfy](https://icones.js.org/) 使用【search】搜索，然后选择一个心仪的图标。

![img](./assets/bda5a16eb8264a479095c11fa563857d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/8ab75c05a672404a9942383016a0d3cb~tplv-k3u1fbpfcp-zoom-1.png)


### Build 时单独导出 CSS
使用 unocss 后，如果运行 pnpm build 的时候会报错。

![image.png](./assets/e024e824201e410ca3fb85937c670d05~tplv-k3u1fbpfcp-watermark.png)
...
![image.png](./assets/c5122a914a764fbd87940c24aa77374f~tplv-k3u1fbpfcp-watermark.png)



![image.png](./assets/2ef0a151099545f897f47e005a507d62~tplv-k3u1fbpfcp-watermark.png)
...
![img](./assets/f8a3ece64eb54824b3b464809505f42f~tplv-k3u1fbpfcp-zoom-1.gif)