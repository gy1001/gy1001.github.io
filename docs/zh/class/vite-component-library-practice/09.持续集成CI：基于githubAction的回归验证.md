...
![img](./assets/c3d7160e2e234baf819750cb1d6f3a5f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/badc4cf035eb411fa77c102438a15840~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/20e0193ec5c14b8eb96205c06d46c6c3~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/9116de9fb2954f4da016b07441742ce0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/fe5c8aa3af3740ce99a7f2cea41bd43d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/bf381af693ed4924a681d63dc15719db~tplv-k3u1fbpfcp-zoom-1.png)

根据触发器的配置，持续集成脚本会在每次提交 push 代码的时候触发。

![img](./assets/9dd0581a65134e48816149f99afa7110~tplv-k3u1fbpfcp-zoom-1.png)

运行成功的话会显示绿色对钩。

如果失败，那么就会显示 ❌ 并且自动发送邮件通知。

![img](./assets/12ded169120a4e2fb6c6856b6193912f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/20aae7a6f9e04164b32ce14ab616e1c8~tplv-k3u1fbpfcp-zoom-1.png)

可以在 README.md 加上一个这样的引用。

![img](./assets/1963fed09400418aacb59ca2574dc819~tplv-k3u1fbpfcp-zoom-1.png)
