# 05-继承进阶：如何实现 new、apply、call、bind 的底层逻辑？
...
![img](./assets/1745313362403-fcece0aa-a44f-4ed6-9a41-491f34a329c8.png)
好了，new 这个关键词内容基本就讲到这里了，我们再看一下 apply 和 call 的基本原理。 

### 1.2. apply & call & bind 原理介绍
...
![img](./assets/1745313362438-3c30371b-a1e7-480d-a656-12994e98f488.png)
