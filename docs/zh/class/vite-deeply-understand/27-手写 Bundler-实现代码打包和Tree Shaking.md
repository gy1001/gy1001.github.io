...
![img](./assets/1745593017674-32ac8a47-84b9-4a4f-b994-ddf7703110fa.png)
...
![img](./assets/1745593017909-02916218-f926-4b07-a2d1-b4f3023fd06f.png)

其中 A 依赖 B 和 C，B 和 C 依赖 D，D 依赖 E，那么最后的拓扑排序即`E、D、B、C、A`。但也有一种特殊情况，就是出现循环的情况，如下面这张图所示:

![img](./assets/1745593017691-065ad884-6b22-403a-97e6-637c3edbd537.png)
...
![img](./assets/1745593017749-1acadaba-e958-45b1-b405-9574750bdc1a.png)
