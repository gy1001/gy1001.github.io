...
对于用户侧来说，谈到框架的更新，文档自然是最重要的部分。现在你可以直接去 [vitejs.dev](https://vitejs.dev) 站点体验到 v3 版本的文档，目前文档同样是使用 [VitePress](https://vitepress.vuejs.org/) 进行搭建。下面是暗黑模式下的一张截

![img](./assets/1745593034325-0ca09509-abd1-4852-8e0f-51a4e0d61ee9-20250426011244380.png)
...
![img](./assets/1745593034150-7bdaa048-c69d-4251-a5ef-6f68bdb452f0.png)
...
![img](./assets/1745593034637-93182e76-1768-46b3-8100-e5478067793e.png)
...
![img](./assets/1745593034091-f8558f00-d49a-4b1a-adf4-a8b42f762dea.png)
...
![img](./assets/1745593034248-466f7d1f-069f-496e-8bb7-439e505fc252.png)
