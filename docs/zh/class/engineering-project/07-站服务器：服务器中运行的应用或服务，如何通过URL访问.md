# 07-站服务器：服务器中运行的应用或服务，如何通过URL访问？
...
![www文件夹](./assets/D439384F-3856-4D68-B668-814BF2479C35.png)

准备好个人官网源码，在`client`文件夹中创建`yangzw`文件夹，把源码拖到`yangzw`中，最终的入口文件路径是`/www/client/yangzw/index.html`。

![官网目录](./assets/9CF18FBB-8F65-45DA-9EE3-992AB6D2B6EE.png)
...
![image-20240416224419038](./assets/image-20240416224419038.png)
