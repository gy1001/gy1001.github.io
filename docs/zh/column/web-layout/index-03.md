...
![img](./assets/c30bdb31294e40f8a98768024de75e09~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/573539dfa0a4447bba9e78a5f676bb63~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/4b4d9872f994445d9a16ff66cae810bf~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/8afb306f1a4f4574a48dc584b542c898~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/68666475866b47989c495d453f057e52~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/d75744e3adb9450298eba491b5ee884e~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/b07d9b08b3ca487a84ad054aa7bd8910~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![fig-02-09.png](./assets/97f114cfde4e4f46a9b8e39f52e4171c~tplv-k3u1fbpfcp-watermark.png)
...
![img](./assets/6d934f676b6a421cb451c42aa4f0432f~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/584b5a15ed2b45bba8615773ca4291cc~tplv-k3u1fbpfcp-zoom-1.jpeg)

可用于 Flex 项目上的属性相比于 Flex 容器上要少一点，它主要有：

![img](./assets/2d832f3e72844710b90bfb3f067cb0c7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/4e355c20b12a47b89c7d100f04f7080a~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/057f3e4f17c548898a4ad7b806fa617a~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/ad5d213431894ffaa8f07cb529586fe8~tplv-k3u1fbpfcp-zoom-1.gif)

另外，CSS 的 `writing-mode` 属性的值也将影响 `flex-direction` 属性最终呈现的效果：

![img](./assets/ae3b869319834fbd9c9832f6cdefe73e~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/a74db025d40949dbb09675e6725b3424~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/c3b45f29e8744b02baa24c9cf26c6a39~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./assets/d0ef9f273ec5443d82442739086e2aab~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/7bdcaaabc2fe4909b7ca695f25efe45a~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/24549d3c13624bfa9df4a5bf7672dd57~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/a1df9b812fd045aa90c265c12b09aeb4~tplv-k3u1fbpfcp-zoom-1.gif)

事实上它并不是我们所期望的效果，我们所期望的效果是下图这样的，布局需要换行，就需要显式的设置 `flex-wrap` 为 `wrap` 。

![img](./assets/68c26d40fbe541269c6b1297f537007c~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/84081b99393446f9a696e4a047e81e35~tplv-k3u1fbpfcp-zoom-1.jpeg)

`flex-wrap: wrap-reverse` 同样也受 `flex-direction` 属性取值的影响：

![img](./assets/ff43e82c27794ccbbb4cafeb3b16e985~tplv-k3u1fbpfcp-zoom-1.gif)
...
![fig-03-23.jpg](./assets/f02937df03a642b3aaa58f7a269b4015~tplv-k3u1fbpfcp-watermark.jpeg)
...
![img](./assets/af09ce83d2964b56ab3e449ea74c5c6d~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/32c99570323b4684a86188b3bfdba637~tplv-k3u1fbpfcp-zoom-1.gif)

在 Flexbox 布局中，在 Flex 项目上使用 `order` 属性可以和在 Flex 容器上使用 `flex-direction` 的 `row-reverse` （或 `column-reverse` ）等同的效果：

![img](./assets/b88537414eb24c65a8463ef7ed9d084b~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/ab2d833ec8464ee28b045b2b0be87b94~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/af369fe12e87402ea1d0080a6b9354a7~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/5af4dd37046748fdb143c7d448d3f08f~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/23af3fc956fd4b71a952065dee652177~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/ecc6f70f8f4649439ef9ca6a512841c8~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/6e1f4925940143f4aca7f422f2ad035e~tplv-k3u1fbpfcp-zoom-1.jpeg)
