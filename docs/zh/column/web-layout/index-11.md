...
![img](./assets/17c85edabf4142409a07bc2dfcbf0bcb~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/db55fe969b2149648556900c2e973ba5~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/f6f0a43c7a1c407ab75b3bbb37c0dc63~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/277c7243c88a4710aa6aaf5b8a269f3c~tplv-k3u1fbpfcp-zoom-1.jpeg)

依此类推，最终你可能创建的是一个 `5 x N` 的网格（`N` 是行网格轨道数量）:

![img](./assets/d86190894c934b82bd9ba9ee1cfbb632~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/0d0b5afd9bbc421b891cd2ba9007bef0~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/fd1430c677f34753898cdf963e34f034~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/e8670c4623494f29b0b10fdf2a7189db~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/aa9cc6095dca41e9b412f1b253150b5f~tplv-k3u1fbpfcp-zoom-1.jpeg)

但是我们可以换一种思路来理解，它可以是两条网格线，只不过前者是以 `-end` 命名的网格线，后者是 `-start` 命名的网格线：

![img](./assets/cc3944f7331f4f1cb87fa074bfa849c6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/f199517e24f74c6cb4f3ac18fb431f13~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/1460f476b00a4048acaf3c23cc2efe99~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/909866500c784ae7930ec67c0cb19743~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/0c91401282c9412b8508ff151b974134~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/bc38354733914e109f80bab1b03ac18f~tplv-k3u1fbpfcp-zoom-1.jpeg)

如此一来，你可以使用 `grid-template-areas` 结构化（可视化）来构建 Web 布局，比如我们常见的一个 Web 布局：

![img](./assets/7f59394d7045472c9151ecb884c38f37~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/3cd38cf9f20e4609a7a01c36883f2423~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/7704a436d43e466ea973280f565e6600~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/9917cf45afc54439a458d114ba5d3bd8~tplv-k3u1fbpfcp-zoom-1.jpeg)

使用**规则①** 可以实现区域填充网格且不留空余空间，但不能使用**规则②** 来给网格留出一个空的或几个空的单元格。可实际生产中，Web 布局有时的确需要有空的单元格存在。比如下图这样的 Web 布局：

![img](./assets/dc2891bc68f746418016f0b6d88c8c68~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/ca931485f3d846b8bd04bafcd2b380de~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/af3030dfa54c4ba1a37fef7bc8677225~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/ba218064b35942cb8b7288810340a951~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/521be410deea4823a5ef43ac4358bc28~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/4f9104c9819d40f3818799617b09a9f6~tplv-k3u1fbpfcp-zoom-1.gif)

> Demo 地址：<https://codepen.io/airen/full/BaxGMmx>

两者差异如下图所示：

![img](./assets/123220480c894bc3ad83d30f1e1d00f0~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/d7b389309edf475d8c6b1281c4d5953d~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/a4ade54df6064b6fb28de9ed3ba745f6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/81cc8e011080481e8a56d298a1ac98a9~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/d520eead57cc4725b08e76941ca5e79d~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/5ff1f82677894aab8d057ba14cf1b2b9~tplv-k3u1fbpfcp-zoom-1.gif)
...
![img](./assets/da18c53d6efd4be79023389bcedbde90~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/15290f5cde984865987e6065ac904605~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/5f5044678e094b2e8a957a667b450a0e~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/181617aa9ad54000b732a01ed194c938~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/c5a74e54982b425fa02868c19b410bcb~tplv-k3u1fbpfcp-zoom-1.gif)

> Demo 地址： <https://codepen.io/airen/full/gOzZGvX>

即网格流受书写模式影响：

![img](./assets/54d99ecf2edd4899b92243d7c3c417a0~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/506632dde6134ac69f87ad7e53ac1c0c~tplv-k3u1fbpfcp-zoom-1.gif)

当 `grid-auto-flow` 取值为 `column` 时，网格项目自动放置会从第一列第一个网格单元格开始，从上往下排列，当网格行轨道数量不够时，会新创建一列网格轨道：

![img](./assets/cd30f5e99a2d40029e7c49252f934655~tplv-k3u1fbpfcp-zoom-1.gif)

`grid-auto-flow` 取值为 `row` 和 `column` 时网格项目自动放置流方向对比如下：

![img](./assets/5e10924ec3a34874adf1d8db41ffb3ec~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/6f2a71db95d54e60b36d70812ded4a87~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/afbebd2dcfdb405ca1bf5c98d07c1ca7~tplv-k3u1fbpfcp-zoom-1.gif)

`row` 、`column` 、`dense` 、`row dense` 和 `column dense` 效果对比如下：

![img](./assets/6dcb35b16ffb4bdc91507268d9508cd6~tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![img](./assets/dc0a9e1f7c6640589d1402243dfcc50d~tplv-k3u1fbpfcp-zoom-1.jpeg)
