...
![](./assets/167ca65dd246e55d~tplv-t2oaga2asx-image.gif)
...
![](./assets/167ca65dd36c5272~tplv-t2oaga2asx-image.gif)
...
![](./assets/167caa871b562a48~tplv-t2oaga2asx-image.gif)
...
![](./assets/167caa8723019208~tplv-t2oaga2asx-image.gif)

## 5.拿到 `source`

与 `drawer console` 一样，当我要专注于 `Elements` 面板时，有时我也想看源代码，这时就可以在 `drawer` 中选择显示 `Source`。

![](./assets/167caa8719c239ee~tplv-t2oaga2asx-image.png)
...
![](./assets/167f829dad411a58~tplv-t2oaga2asx-image.png)

它不仅会使用差异形式的变化（像 `Git` 这样的源控制工具一样）向你展示，同时还可以撤销它们。 

举个例子：

![](./assets/167f829dadf27e11~tplv-t2oaga2asx-image.gif)
