...
![image-20240416180443262](./assets/image-20240416180443262.png)

因为结构简单，我们甚至不需要组件，直接使用标准的 table 系列标签就可以。但有的时候，除了呈现数据，也会带有一些交互，比如有一列操作栏，可以编辑整行的数据：


![image-20240416180455047](./assets/image-20240416180455047.png)
...
![image-20240416180523414](./assets/image-20240416180523414.png)
...
![image-20240416180544502](./assets/image-20240416180544502.png)
...
![image-20240416180608212](./assets/image-20240416180608212.png)
