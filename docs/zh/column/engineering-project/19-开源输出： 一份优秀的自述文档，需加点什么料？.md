...
![image-20240416234402757](./assets/image-20240416234402757.png)

其中有几个配置字段尤为重要，以第 15 章封装的工具库为例，以下将一一展开讲述。
...
`Semver`的出现规定了版本如何表示如何迭代如何比较。遵从`Semver规范`的`Npm模块`，其依赖会很清晰，不会出现循环依赖、依赖冲突等常见问题。关于`Semver`的完整规范可查看[Semver 官网](https://link.juejin.cn/?target=https%3A%2F%2Fsemver.org%2Flang%2Fzh-CN)。
...
![版本编号](./assets/FF998D5C-A534-4677-ADF1-3281F9CBA28D.png)
...
第 15 章开发工具库时就埋下该问题。在开发前就明确清楚`Npm模块`的应用场景。
...
第 15 章开发的工具库可在`Web`与`Node`中使用，那仅仅一个`main`字段是无法保障在`Web`中加载哪个文件，在`Node`中又加载哪个文件，因此在不同环境中加载`Npm模块`不同入口文件，显然一个`main`字段已不能够满足需求，这就衍生出`module`与`browser`两个字段。

根据`CJS/ESM/UMD`的特性与`Npm官网`对`main/module/browser`字段的描述，可得到以下对应关系。

![入口文件](./assets/D7353BAF-EEFF-4972-B0D9-44052DA55538.png)
...
针对第 15 章开发的工具库，很明显符合最后一种情况，在`package.json`中指定以下字段。
...
![image-20240416234844270](./assets/image-20240416234844270.png)
...
![许可证书](./assets/684176A4-948E-4B69-B662-1C6BFF16A8D9.png)
...
![Readme](./assets/AC97DCC1-1F89-410A-98A5-1B80586D59BC.png)
...
![image-20240416234930502](./assets/image-20240416234930502.png)
...
![BMW 330Li](./assets/5EE2135D-A69D-4298-AE1C-2D335F86BC16.png)
...
[![Name](./assets/5BE43144-977D-4F85-A853-A5636AE9B842.png)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)

[![Sex](./assets/2643E714-C0B8-4861-86AF-343F86D5CB88.png)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)

[![Age](./assets/B2380727-D410-4C1D-BEB9-782E0FECD054.png)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)

[![Area](./assets/6748D4E5-9B88-4919-9965-69A9DE8AD6C9.png)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)
...
![@yangzw/bruce-app](./assets/0E847F38-234E-4AB9-90FB-AA60F8109C80.png)
...
![@yangzw/bruce-app](./assets/CCA39D28-8D9E-4EBD-AF6A-B116FD070821.png)
...
![@yangzw/bruce-app](./assets/A863BC43-E855-4858-A288-E3D5F1263C7A.png)
...
![@yangzw/bruce-app](./assets/0328B72E-2A1C-4A6C-B6FB-21727335A861.png)

---

另外`Github`也提供类似的徽章服务，若要实时展示自己项目的`Star`、`Fork`和`Watch`，可在`Readme`中加入以下内容。

![image-20240416233910796](./assets/image-20240416233910796.png)
...
![自定义统计数据](./assets/53EF2EBB-6264-49EA-8A8B-7A91932C087F.png)
